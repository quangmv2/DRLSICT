...
Route::group(['middleware' => 'studentMiddleware'], function () {
    ...
    Route::group(['prefix' => 'diem-ren-luyen-cua-toi'], function () {
        ...
        Route::get('/danh-sach-lop/{id_dot}', "ClientController\MyPointController@getPublicPoint")->name('public-diem');
    ...
    Route::group(['prefix' => 'diem-ren-luyen'], function () {
        ...
        Route::group(['prefix' => 'danh-sach-dot'], function () {
            ...
            Route::get('/download/pdf/{id_dot}', "ClientController\PointController@downloadAllPointPDF")->name('downloadAllPointPDF');
        });
    });
});
